...
custom_labels = {"inputs/T2K_inputs/oscillation_weights_allzero_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "PMNS Model", "inputs/T2K_inputs/oscillation_weights_epsemuonly_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_emu = 0.25 delta_emu=0", "inputs/T2K_inputs/oscillation_weights_epsemudeltaemupi2_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_emu = 0.25 delta_emu=pi/2", "inputs/T2K_inputs/oscillation_weights_epsemudeltaemupi_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_emu = 0.25 delta_emu=pi", "inputs/T2K_inputs/oscillation_weights_epsemudeltaemu3pi2_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_emu = 0.25 delta_emu=3pi/2"}

#custom_labels = {"inputs/T2K_inputs/oscillation_weights_allzero_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "PMNS Model", "inputs/T2K_inputs/oscillation_weights_epseeonly_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_ee = 0.25", "inputs/T2K_inputs/oscillation_weights_epsemuonly_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_emu = 0.25", "inputs/T2K_inputs/oscillation_weights_epsetauonly_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_etau = 0.25", "inputs/T2K_inputs/oscillation_weights_epsmumuonly_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_mumu = 0.25", "inputs/T2K_inputs/oscillation_weights_epsmutauonly_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_mutau = 0.25", "inputs/T2K_inputs/oscillation_weights_epstautauonly_onlyecouplings_NOvAbaseline_deltaCPfix.txt" : "eps_tautau = 0.25"}
...
file = uproot.open("inputs/nue/P_asimov0_nue_NSI_epsemu_NO.root")
...
for idx, (file_name, label) in enumerate(custom_labels.items()):
    ...
    output_path = f"Diffplots_NOvAbaseline_nue_{label_clean}.jpg"
